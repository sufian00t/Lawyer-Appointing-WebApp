...
$result=editLawyer($uname);
?>
<!DOCTYPE html>
<html>
<head>
    <link rel="stylesheet" href="\Mr. Attorneyy\Views\styleUpdateLawyer.css">
    <meta charset="utf-8">
...
<body>
    <form action="/Mr. Attorneyy/Controller/Update.php" method="post">
        <h1 align="center"><u>Update Lawyer</u></h1> <br><br>
    <?php while($row=$result->fetch_assoc()){ ?>
        <b>User : <input type="text" name="Use" value="Lawyer" readonly> <br><br>
        <b>E-Mail : <input type="email" name="Mail" value="<?php echo $row["Mail"] ?>"> <br><br>
