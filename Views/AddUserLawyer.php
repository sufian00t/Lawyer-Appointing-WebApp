...
<html>
<head>
    <link rel="stylesheet" href="\Mr. Attorneyy\Views\styleAddUserLawyer.css">
    <meta charset="utf-8">
...
<body>
    <form action="../Controller/Entry.php" method="post">
        <h1 align="center"><u> Add Lawyer </u> </h1> <br> <br>
        <b>User : <input type="text" name="User" value="Lawyer" readonly > <br> <br>
