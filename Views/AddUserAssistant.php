...
<html>
<head>
    <link rel="stylesheet" href="\Mr. Attorneyy\Views\styleAddUserAssistant.css">
    <meta charset="utf-8">
...
<body>
    <form action="../../Controller/Entry.php" method="post">
        <h1 align="center"><u> Add Assistant </u> </h1> <br> <br>
        <b>User : <input type="text" name="User" value="Assistant" readonly > <br> <br>
        ...
        <b>Lawyer : <input type="text" name="lawyer"> <br> <br>
        <b>Gender : 
